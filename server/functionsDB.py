...
# get all the quiz attempts generated by a user
def Fetch_quiz_attempts_by_user(user_id):
    try:
        collection=db["QuizAttempts"]
        attempts=list(collection.find({"studentId": user_id}))
        if not attempts:
            return "error : Quiz attempts not found"
        else :
        ...
        return f"Error : fetching quiz attempts {str(e)}"
