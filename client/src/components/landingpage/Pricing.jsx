        ...
        <div className="container lg-centered py-10 px-4">
            ...
            <div className=' lg:flex lg:gap-4 xl:flex xl:gap-14 md:justify-center lg:items-end'>
                { pricingTiers.map((tier,i)=>{
                    return <div key={i} className={twMerge(' bg-white p-10 border border-[#F1F1F1] rounded-3xl shadow-[0_7px_14px_#EAEAEA] mb-6 relative overflow-hidden max-w-[450px] mx-auto', tier.pp === true && "border-[3px] border-primary")}>
