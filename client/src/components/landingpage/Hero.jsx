        ...
        <div>
            <div className='container lg-centered'>
                <div className='md:flex items-center gap-6'>
                    <div className='max-w-[400px] md:w-[470px]'>
                        <div>
                            ...
                            <h1 className='text-4xl md:text-3xl font-bold tracking-tighter bg-gradient-to-b from-black to-[#1884FF] text-transparent bg-clip-text mt-6'>{herotext.title}</h1>
                            <p className='text-lg text-[#010D3E] tracking-tight mt-6 md:text-medium'>{herotext.subtitle}</p>
                        </div>
                        {/* buttons section */}
                    ...
                    <div className=' hidden md:block mt-20 md:mt-0 md:w-2/3 lg:w-2/4 lg:ml-28 lg:right-0 xl:ml-40 xl:right-0'>
                        <motion.img src={heroimage} alt=" Prepgenius hero image" />
                    </div>
                </div>
